...
$.extend($.validator, {
	...
	messages: {
		...
		creditCart: "Please enter a valid credit Cart number.",
	...
	methods: {
		...
		// http://docs.jquery.com/Plugins/Validation/Methods/creditCart
		// based on http://en.wikipedia.org/wiki/Luhn
		creditCart: function(value, element) {
			if ( this.optional(element) )
				return "dependency-mismatch";
